      ...
      return declare([BaseWidget], {
        ...
        postCreate: function() {
            ...
            sources = [{
              ...
              highlightSymbol: new PictureMarkerSymbol("https://js.arcgis.com/3.27/esri/dijit/images/sdk_gps_location.png", 27, 27).setOffset(9, 18)
            }]
            ...
            onClickSolve: function() {
              ...
              m_closestFacilityTask.solve(params,
                ...
                function(err) {
                  ...
                  alert("No se ha podido calcular la ruta posiblemente porque no hay ninguna solución que cumpla el tiempo máximo establecido");
                });
            }
